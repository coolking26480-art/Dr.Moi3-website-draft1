...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center bg-[rgba(15,30,58,0.85)] backdrop-blur-[8px] animate-[fadeIn_0.2s_ease-out]"
      onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div className="bg-white rounded-xl max-w-[480px] w-[90%] p-8 relative animate-[scaleIn_0.2s_ease-out]">
        <button
          onClick={onClose}
